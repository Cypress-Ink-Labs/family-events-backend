-- Rollback for 20260724010000_plan_events_range_halfopen_and_age_fix.sql
--
-- Restores public.plan_events_for_user_range() to the body introduced by
-- 20260620030000_plan_events_for_user_range.sql.

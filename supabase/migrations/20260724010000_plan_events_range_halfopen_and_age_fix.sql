-- Migration: 20260724010000_plan_events_range_halfopen_and_age_fix.sql
--
-- Makes digest candidate ranges half-open and scores one-sided age ranges
-- against their only violated bound. The function signature and grants stay
-- unchanged, so CREATE OR REPLACE is sufficient.
--
-- Paired rollback:
--   supabase/rollbacks/20260724010000_plan_events_range_halfopen_and_age_fix_down.sql
